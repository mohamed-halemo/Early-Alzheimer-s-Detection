...
def convertNsave(arr,file_dir, index=0,window_center=None,window_width=None):
    ...
    # Convert the image data to uint16
    epsilon = 1e-12
...
ConvertNIFTI("ADNI_023_S_0042_MR_MPR-R__GradWarp__B1_Correction__N3__Scaled_Br_20061130173634563_S8852_I31084.nii","axial")
ConvertNIFTI("ADNI_023_S_0042_MR_MPR-R__GradWarp__B1_Correction__N3__Scaled_Br_20061130173634563_S8852_I31084.nii","coronal")
